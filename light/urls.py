...
urlpatterns = [
    ...
    path('settings&action=profile/', views.settings_profile, name='settings_profile'),
    path('settings&action=contact/', views.settings_contact, name='settings_contact'),
    ...
    path('toggle-admin&target=<str:pk>/', views.toggle_admin, name='toggle_admin'),
    path('deactivate-user&target=<str:pk>/', views.deactivate, name='deactivate'),
    path('activate-user&target=<str:pk>/', views.activate, name='activate'),
    #edit
    path('update-trade&target=<str:pk>/', views.update_trade, name='update_trade'),
    path('delete-trade&target=<str:pk>/', views.delete_trade, name='delete_trade'),
    path('update-deposit&target=<str:pk>/', views.update_deposit, name='update_deposit'),
    path('delete-deposit&target=<str:pk>/', views.delete_deposit, name='delete_deposit'),
    #deposit
    ...
    #semi auth urls
    path('change-password&account=<str:cust>/', views.settings_password, name='change_password'),
