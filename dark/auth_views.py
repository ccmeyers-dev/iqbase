...
def profile(request):
        ...
        if form.is_valid():
            ...
            if settings.DEBUG:
                ...
                try:
                    ...
                    html_message = render_to_string('dark/mail.html', {
                        'name': name,
    ...
    context = {'form': form}
    return render(request, 'dark/template_dark/signup-profile.html', context)
...
def register_view(request):
    ...
    if request.POST:
        ...
        context['form'] = form
    return render(request, 'dark/template_dark/signup.html', context)
...
def login_view(request):
    ...
    return render(request, 'dark/template_dark/signin.html', context)
...
def referral(request):
    ...
    return render(request, 'dark/template_dark/referral.html')
